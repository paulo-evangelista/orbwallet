  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col justify-between p-6">
      <header className="text-center mb-8">
        <h1 className="text-3xl font-bold text-purple-400">Log In to OrbWallet</h1>
      </header>
      ...
      <main className="flex-grow flex flex-col justify-center space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="server" className="text-sm font-medium text-gray-300">Server</Label>
          <Select defaultValue={server} onValueChange={setServer}>
            ...
            <SelectContent className="bg-zinc-800 border-none">
              <SelectItem value="xxx.com" className="text-white focus:bg-purple-500">xxx.com</SelectItem>
              <SelectItem value="yyy.com" className="text-white focus:bg-purple-500">yyy.com</SelectItem>
              <SelectItem value="zzz.com" className="text-white focus:bg-purple-500">zzz.com</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </main>
